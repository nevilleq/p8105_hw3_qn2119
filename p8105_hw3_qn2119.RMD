...
We then obtained linear and smoothed spaghetti plots of the number of locations in each state from 2002 to 2010. 
...
```{r fig.width = 8, fig.height = 10, out.width = "90%", fig.asp = 1}
