...
```{r}
  ...
  labs(
    x = expression(paste("Average Min. Temperature ( ", degree ~ C, ")")),
    y = expression(paste("Average Max. Temperature ( ", degree ~ C, ")")),
    title = "Density of Maximum and Minimum Temperatures, NYC NOAA"
  )
  
gg.min.max +  geom_hex(binwidth = c(1.8,1.8))
#gg.min.max + geom_density_2d()
#?geom_hex
```
