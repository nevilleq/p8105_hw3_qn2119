...
gg.avg.temp + geom_line(alpha = 0.3)
```

<img src="p8105_hw3_qn2119_files/figure-markdown_github/unnamed-chunk-7-1.png" width="90%" />

``` r
gg.avg.temp + geom_point(alpha = 0.3)
```

<img src="p8105_hw3_qn2119_files/figure-markdown_github/unnamed-chunk-7-2.png" width="90%" />

``` r
gg.avg.temp + geom_boxplot()
```

<img src="p8105_hw3_qn2119_files/figure-markdown_github/unnamed-chunk-7-3.png" width="90%" />
